...
On March 2026, TCM Security organized a Blue Team CTF. This TCM first time Blue Team CTF designed by MalwareCube was available on this link:

Link if the event: https://ctf.tcmsecurity.com/?hsCtaAttrib=209031787124

Here is decription we could read on the CTF website:
...
The first thing I did was to check the aspect of the archive and its content.
...
The I choose to analyze $MFT file because this file may keep traces. But this is a big file (242 MB). Maybe I will find removed files.
...
Here is the file in text mode (I removed a part of it):
```
---------------------------------------
...
- Values from 1000 to 4999.9 incrementing by 0.1 seem pointless but that makes a big file
- There is something about quaternary
	- base4?
- Files removed intentionaly by Dr Owens
- Files to download ?
	- LOG_086
	- LOG_087
	- LOG_088
...
I try to remove the name of the file to see if I can find something:
...
I try another approch: bruteforce the zip file.
- john?
...
JavaScript console (before I had ean error):
```
...
2. Then I use "RADIO FREQ" button to get XXXX.8 or XXXX.3 (it worked with 0205.3 Hz and 184.3 Hz)
...
- Each bit/frequency last around 1 second so it is a 1 Hz element
...
Usually when we use a spectrum analyser, 0.1 Hz of difference is not that important. But here it was crucial and totally stopped me. I spent most of my time on the Frequency Machine. But when I used "gold fingers" technique then things goes fine.

The time spent for this TCM CTF was:

Beginning:
- UTC 18:23 2026-03-11
End:
- UTC 06:43 2026-03-12
Total (including a pause of 6 hours and VM plus software installation):
- 12:20
